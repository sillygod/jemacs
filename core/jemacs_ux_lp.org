...
* evil
  ...
  #+begin_src emacs-lisp
    (use-package evil
      ...
      (evil-define-key 'normal prog-mode-map (kbd "g e") 'diff-hl-show-hunk)
  ...
  xwidget: evil-collection already maps hjkl / history / yy.
  =jwebkit= adds in-page search, ace hints, and typing into the page.
  After editing, drop straight's build cache:

  #+begin_src emacs-lisp :tangle no
    (delete-directory (expand-file-name "straight/build/jwebkit" user-emacs-directory) t)
  #+end_src

  #+begin_src emacs-lisp
    (eval `(use-package jwebkit
             :straight (:local-repo ,(concat home-dir "local/jwebkit"))
