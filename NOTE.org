* Some plugins can be referenced
  ...
  implement a features that bookmark some commands for every project 
  TAG=test3 docker build . -t asia.gcr.io/staging-211402/gorilla:test3
...
** things needed to be done or enahnced
   ...
   - [ ] implement my own run-python-shell (can learn from claude code cli or gemini cli https://github.com/linchen2chris/gemini-cli.el)
