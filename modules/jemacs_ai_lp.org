  ...
  #+begin_src emacs-lisp
    (eval `(use-package ghostherd
             :straight (:local-repo ,(concat home-dir "local/ghostherd")
                                    ;; ecloud's recipe copies server/ into the
                                    ;; straight build; without this, locate-library
                                    ;; sees only .elc and the sidecar is invisible.
                                    :files ("*.el" "server"))
             ...
             ;;   /        live-narrow.  evil-search would otherwise steal it.
             ;;
